...
function Logo() {
  return (
    <div className="flex items-center gap-2.5">
      ...
      <div>
        <div className="font-bold text-stone-900 text-base leading-none">
          Shawaf
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            ...
            <p
              className="mt-4 text-sm text-stone-500 leading-relaxed"
              dir="auto"
            >
              {t('footerDesc')}
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-stone-500">
              <li className="flex items-center gap-2">
                ...
                <span dir="ltr">info@shawaf.sa</span>
              </li>
              ...
              <li className="flex items-center gap-2">
                ...
                <span dir="auto">{text.location}</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-10 pt-6 border-t border-stone-200 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-stone-400">
          <span dir="auto">© 2026 Shawaf — شواف</span>
